...
void progressCallBack(size_t currSize, size_t totalSize) {
  Serial.printf("CALLBACK:  Update process %d%%\n", (currSize*100)/totalSize);
}

#define FIRMWARE_VERSION 0.2

void SDCard::SDCardBegin(uint8_t pinChipSelect) {
  // Serial.begin(115200);
  while (!Serial) {
...
void SDCard::SDCardUploadFirmware(String filename) {
