...
void OTA_AP::OTASetHostname(const char *HOST) {
  OTA_AP::host = HOST;
}

void OTA_AP::OTASetAP(const char *SSID, const char *PASSWORD) {
  OTA_AP::ssid = SSID;
  OTA_AP::password = PASSWORD;
}

void OTA_AP::onJavaScript(void) {
